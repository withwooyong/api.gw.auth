package com.spring.cloud.api.gw.auth.aspect;
...
public class Logging {
     ...
     */
    @Pointcut("execution(* com.spring.cloud.api.gw.auth.controller..*Controller*.*(..)) || execution(* com.spring.cloud.api.gw.auth.service..*Service*.*(..))")
    private void cut() {
    }
